...
func (r *PaymentRepo) DeletePaymentMethod(ctx context.Context, userID int, sourceID int, sourceName string) error {
...
func (r *PaymentRepo) GetPaymentMethod(ctx context.Context, userID int, sourceName string) (models.PaymentMethod, error) {
	var (
